...
- Verify mobile 390 px / 16 px and desktop 800 px / 14 px at scale 1 in a sufficiently wide viewport; preview and copied/exported images must keep identical wrapping and proportions, while legacy or custom profile inputs normalize to mobile.
